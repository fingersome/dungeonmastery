...
import dungeonmastery.network.server.OpenGuiMessage;
...
public class KeyHandler
{
	...
	private static final String[] desc = {"key.char_inv.desc"};
	...
	public KeyHandler(Minecraft mc) 
	{
		...
		{
			keys[i] = new KeyBinding(desc[i], keyValues[i], StatCollector.translateToLocal("key.char_inv.label"));
	...
	public void onKeyInput(KeyInputEvent event) 
	{
		...
		if (mc.inGameHasFocus) 
		{
			...
			{
				PacketDispatcher.sendToServer(new OpenGuiMessage(DungeonMastery.GUI_CHAR_INV));
