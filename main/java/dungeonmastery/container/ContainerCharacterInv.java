...
import dungeonmastery.container.slot.SlotArmor;
import dungeonmastery.inventory.slot.SlotCustom;
...
import net.minecraft.item.ItemStack;
 ...
 public class ContainerCharacterInv extends Container
{
/** Avoid magic numbers! This will greatly reduce the chance of you making errors in 'transferStackInSlot' method */
private static final int ARMOR_START = InventoryCharacter.INV_SIZE, 
...
public ContainerCharacterInv(EntityPlayer player, InventoryPlayer inventoryPlayer, InventoryCharacter inventoryCharacter)
{
int i;
...
this.addSlotToContainer(new SlotCustom(inventoryCharacter, 0, 80, 8));
this.addSlotToContainer(new SlotCustom(inventoryCharacter, 1, 80, 26));
...
{
if (!this.mergeItemStack(itemstack1, 0, InventoryCharacter.INV_SIZE, false))
{
return null;
}
}
