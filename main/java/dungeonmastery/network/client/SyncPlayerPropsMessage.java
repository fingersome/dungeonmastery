package dungeonmastery.network.client;
...
public class SyncPlayerPropsMessage extends AbstractClientMessage<SyncPlayerPropsMessage>
{
	...
	private NBTTagCompound characterdata;
	...
	{
		characterdata = buffer.readNBTTagCompoundFromBuffer();
	}

	@Override
	protected void write(PacketBuffer buffer) throws IOException 
	{
		buffer.writeNBTTagCompoundToBuffer(characterdata);
	}
