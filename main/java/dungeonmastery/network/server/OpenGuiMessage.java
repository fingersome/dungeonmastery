package dungeonmastery.network.server;

import net.minecraft.entity.player.EntityPlayer;
import net.minecraft.network.PacketBuffer;
import net.minecraftforge.fml.relauncher.Side;
import dungeonmastery.DungeonMastery;
import dungeonmastery.network.AbstractMessage.AbstractServerMessage;
...
public class OpenGuiMessage extends AbstractServerMessage<OpenGuiMessage>
{
	...
	public void process(EntityPlayer player, Side side) 
	{
		...
		player.openGui(DungeonMastery.instance, this.id, player.worldObj, (int) player.posX, (int) player.posY, (int) player.posZ);
	}
}